...
class AgenteTresEnRaya(AgenteJugador):
    ...
    def mostrar(self, estado):
        ...
        for x in range(1, self.h + 1):
            ...
            print()
        # print("utilidad: ", estado.get_utilidad)
    ...
    def en_raya2(self,tablero,jugador):
        for j in range (1,4):
            if tablero.get((j, 1))== jugador and tablero.get((j, 2))==jugador and tablero.get((j, 3))==jugador:
                return True
            if tablero.get((1, j))==jugador and tablero.get((2, j))==jugador and tablero.get((3, j))==jugador:
                return True
        if tablero.get((1, 1))==jugador and tablero.get((2, 2))==jugador and tablero.get((3, 3))==jugador:
            return True
        if tablero.get((3, 1))==jugador and tablero.get((2, 2))==jugador and tablero.get((1, 3))==jugador:
            return True
        return False
